...
import com.heuristic.algorithm.ALO.ALO;
import com.heuristic.algorithm.DA.DA;
import com.heuristic.algorithm.DA_GWO.DA_GWO;
import com.heuristic.algorithm.GWO.GWO;
import com.heuristic.algorithm.PSO.PSO;
...
public class Test {
    ...
    static double PSO_res[][] = new double[23][30];
    static double ALO_res[][] = new double[23][30];
...
//        calPvalue();
    ...
    public static void PSO(int times) throws Exception {
        ...
        ExcelUtils.fillAvgAndStdToExcel(f_test.N, f_test.maxiter, times, avg,std, 6);
        ExcelUtils.fillBestScoreToExcel(PSO_res, 23, times, 87);
    }
    ...
    public static void ALO(int times) throws Exception {
        ...
        ExcelUtils.fillAvgAndStdToExcel(f_test.N, f_test.maxiter, times, avg,std, 8);
        ExcelUtils.fillBestScoreToExcel(ALO_res, 23, times, 116);
    }
